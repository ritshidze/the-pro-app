...
<div class="col-md-12">
    <div class="card">
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('store-people') }}">
                @csrf
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="id_number" type="text" class="form-control @error('id_number') is-invalid @enderror"
                            name="id_number" maxlength="13" size="13" value="{{ old('id_number') }}" required autocomplete="id_number" autofocus>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="mobile_number" type="text" class="form-control @error('mobile_number') is-invalid @enderror"
                            name="mobile_number" maxlength="10" size="10" value="{{ old('mobile_number') }}" required autocomplete="mobile_number" autofocus>
